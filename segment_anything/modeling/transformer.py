...
class MoEFFN(nn.Module):
    def __init__(self, dim, hidden_dim, num_experts):
        ...
        self.dim=dim  #nn.Linear(dim, dim*num_experts)
    ...
    def forward(self, x,modality):
        ...
        batch_size,c,d=gate_weights.shape
        gate_weights = gate_weights.reshape (self.num_experts,batch_size,-1,self.dim)
...
class TwoWayAttentionBlock(nn.Module):
    ...
    def forward(
        self, queries: Tensor, keys: Tensor, query_pe: Tensor, key_pe: Tensor,modality:Tensor
    ) -> Tuple[Tensor, Tensor]:
        ...
        # MLP block
        mlp_out = self.mlp(queries,modality)
